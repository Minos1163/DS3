...
def main():
    ...
    parser.add_argument('--pattern', type=str, default='logs/deep_grid_parallel_full_*.csv', help='Glob pattern for parallel CSV')
    parser.add_argument('--report', type=str, default='reports/experiment_summary.md', help='Experiment summary file to append')
    ...
    if stable is None:
        ...
        return
    top_df, out_csv = aggregate_topn(stable, topn=args.topn, max_dd_percent=args.max_dd)
