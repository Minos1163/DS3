...
row = pd.Series(
    {"close": 100.0, "rsi": 50.0, "ema_5": 0, "ema_20": 0, "macd_hist": 0, "volume_quantile": 1.0},
...
print(
    "after close:",
    hasattr(bt, "position_notional"),
    getattr(bt, "position_notional", None),
    getattr(bt, "leveraged_notional", None),
)
